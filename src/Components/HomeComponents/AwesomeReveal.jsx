  ...
  return (
    <div className="py-2 md:py-6 lg:py-8 bg-base-100 flex items-center justify-center">
      <div className=" w-full rounded-3xl shadow-2xl p-8 md:p-12 bg-base-200">
        <Fade>
          <h1 className="text-3xl md:text-4xl font-extrabold mb-4 text-center bg-clip-text">
            Welcome to
          </h1>
          <h1 className="text-3xl md:text-4xl font-extrabold mb-4 text-center bg-clip-text">
            BD Food Storage
        ...
        <Fade cascade damping={1}>
          <h2 className="text-2xl font-semibold mb-4 border-b-2 border-[#176AE5] pb-2 text-center">
            Why BD Food Storage?
          </h2>
          <ul className="list-disc list-inside space-y-2 text-lg">
            <li className="hover:text-[#176AE5] transition-colors duration-300 cursor-pointer">
